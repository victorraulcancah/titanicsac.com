...
where u.usuario_id = '{$_POST['usr']}'";
  ...
  telefono='{$data['telefono']}'";
    ...
    {
        $result = array();
        $sql = "SELECT DISTINCT medida FROM productos WHERE medida IS NOT NULL AND medida <> '' ORDER BY medida";
    ...
    public function obtenerMercadosClientes(){
        $result = array();
        $sql="SELECT mercado FROM clientes
