...
class ReportesVentaController extends Controller
{
  ...
  {
    // mPDF (version antigua) dispara Deprecated/Notice/Warning en PHP 8 que rompen la salida del PDF.
    // Silenciamos esos niveles y capturamos la salida; cada metodo la descarta antes de Output().
