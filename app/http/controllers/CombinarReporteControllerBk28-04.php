    ...
    public function consolidadoPedidosCamion()
    {
        ...
        foreach ($mercados as $merc) {
            ...
            $query_productos = "SELECT p.codigo,
                ...
                MAX(pc.presenta_cnt) AS total_medida, pc.medida,
            ...
            $query_productos .= " GROUP BY p.codigo, pc.id_producto, p.descripcion, pc.medida ORDER BY TRIM(p.descripcion) ASC, p.codigo ASC";
