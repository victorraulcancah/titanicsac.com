                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-primary" id="btnAgregarPago"><i class="fas fa-plus"></i> Agregar Pago</button>
...
<script>
    ...
    $(document).ready(function() {
            ...
            success: function(data) {
                ...
                datatable = $("#datatable").DataTable({
                    ...
                    columns: [{
                        ...
                        // Botón para editar cotizaciones
                        {
                            data: null,
                            class: "text-center",
                            render: function(data, type, row) {
        ...
        $("#datatable").on("click", ".btnDetalles ", function(event) {
            ...
            // Guardar el tipo en el modal para usarlo después
            $("#exampleModal").data("tipo-documento", tipo);
...
${listaOpc.join("")}
        ...
        $('#btnAgregarPago').click(function() {
            ...
            // Obtener el tipo de documento guardado en el modal
            let tipoDoc = $("#exampleModal").data("tipo-documento");
            
            // Si no se pudo obtener del modal, intentar de la primera fila
            if (!tipoDoc) {
                let primerFila = datatable.row(0).data();
                tipoDoc = primerFila ? primerFila.tipo_doc : 'c'; // Por defecto 'c' para cotizaciones
            }
            
            console.log("Tipo documento para nueva fila:", tipoDoc);
