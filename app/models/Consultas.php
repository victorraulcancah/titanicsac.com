...
class Consultas
{
    ...
    function buscarProductoCoti($id_empresa, $term)
    {
        ...
        where id_empresa = '$id_empresa' and (descripcion like '%$term%' OR codigo like '%$term%') and sucursal='{$_SESSION['sucursal']}' and estado='1' AND activo='1'
    ...
    function buscarProducto($id_empresa, $term, $alma)
    {
        ...
        where id_empresa = '$id_empresa' 
          ...
          AND almacen = '$alma' and estado='1' AND activo='1' order by descripcion asc limit 500";
        //echo $sql;
